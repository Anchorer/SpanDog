...
public class TouchableTextView extends AppCompatTextView {
    ...
    public TouchableTextView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public TouchableTextView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
